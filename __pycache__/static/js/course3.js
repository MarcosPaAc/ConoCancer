  ...
  lessons.forEach(lesson => {
    lesson.addEventListener("click", () => {
      ...
      if (type === "video") {
        ...
        breadcrumb.innerText = `Diagnosis › ${title}`;
      } else if (type === "reading") {
        loadReading(id);
        readingSection.style.display = "block";
        breadcrumb.innerText = `Diagnosis › ${currentLanguage === "en" ? "Reading" : "Lectura"}`;
      } else if (type === "quiz") {
        loadQuiz(id);
        quizSection.style.display = "block";
        breadcrumb.innerText = `Diagnosis › ${currentLanguage === "en" ? "Quiz" : "Cuestionario"}`;
      }
    });
  });
